...
class FirstGateDuplicationTest {

    @BeforeAll
    static void setUp() throws Exception {
        Gate.loadGates(new FirstGateDuplicationTest());
        Operator.loadOperators(new FirstGateDuplicationTest());
    }

    @Test
    void testFirstGateDuplicationApply() {
        FirstGateDuplication op = new FirstGateDuplication();
        op.setName("FirstGateDuplication");
        ...
        // Column size should be 3 for the mutant because H gets duplicated
    }
}
