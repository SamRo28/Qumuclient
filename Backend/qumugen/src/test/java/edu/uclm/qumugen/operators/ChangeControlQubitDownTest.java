...
class ChangeControlQubitDownTest {

    @BeforeAll
    static void setUp() throws Exception {
        Gate.loadGates(new ChangeControlQubitDownTest());
        Operator.loadOperators(new ChangeControlQubitDownTest());
    }

    @Test
    void testChangeControlQubitDownApply() {
        ChangeControlQubitDown op = new ChangeControlQubitDown();
        op.setName("ChangeControlQubitDown");

        String json = "{\"init\":[\"0\",\"0\",\"0\",\"0\"],\"cols\":[[\"•\",\"1\",\"X\",\"1\"], [\"1\",\"•\",\"1\",\"X\"], [\"•\",\"1\",\"X\",\"1\"], [\"1\",\"1\",\"1\",\"1\"]]}";
